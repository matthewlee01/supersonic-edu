...
var file = cljs.core.get.call(null,map__28275__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__28275__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28275__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e28274){var _e = e28274;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___28277 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___28277)){
var seen_errors_28278 = temp__4655__auto___28277;
if(cljs.core.truth_(seen_errors_28278.has(self))){
} else {
seen_errors_28278.add(self);

var temp__4657__auto___28279 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___28279)){
var sense_28280 = temp__4657__auto___28279;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28280)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1532452673633
