...
var temp__4655__auto___40315 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40315)){
var seen_errors_40316 = temp__4655__auto___40315;
if(cljs.core.truth_(seen_errors_40316.has(self))){
} else {
seen_errors_40316.add(self);

var temp__4657__auto___40317 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40317)){
var sense_40318 = temp__4657__auto___40317;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40318)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1532451316665
