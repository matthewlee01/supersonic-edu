...
}catch (e26748){var _e = e26748;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___26751 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___26751)){
var seen_errors_26752 = temp__4655__auto___26751;
if(cljs.core.truth_(seen_errors_26752.has(self))){
} else {
seen_errors_26752.add(self);

var temp__4657__auto___26753 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___26753)){
var sense_26754 = temp__4657__auto___26753;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26754)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1532367478261
