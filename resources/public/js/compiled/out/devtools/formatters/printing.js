...
var len__4499__auto___27580 = arguments.length;
var i__4500__auto___27581 = (0);
while(true){
if((i__4500__auto___27581 < len__4499__auto___27580)){
args__4502__auto__.push((arguments[i__4500__auto___27581]));

var G__27582 = (i__4500__auto___27581 + (1));
i__4500__auto___27581 = G__27582;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27577){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27578,G__27579,seq27577__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27583_SHARP_){
return !((cljs.core.meta.call(null,p1__27583_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__27584__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27588){var _e__26600__auto__ = e27588;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e27590){var _e__26600__auto__ = e27590;
return false;
}}
})())){
...
var _STAR_current_state_STAR_27592 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__27593 = opts;
...
var markup_db = cljs.core.get.call(null,map__27593__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_27592;
}});
...
;
var temp__4655__auto___27597 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___27597)){
var managed_print_level_27598 = temp__4655__auto___27597;
var _STAR_print_level_STAR_27596_27599 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_27598;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_27596_27599,managed_print_level_27598,temp__4655__auto___27597,writer,opts,job_fn){
return (function (p1__27595_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__27595_SHARP_,null);
});})(_STAR_print_level_STAR_27596_27599,managed_print_level_27598,temp__4655__auto___27597,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_27596_27599;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1532452672625
