...
var G__23068 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__23068,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__23068;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq23070){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23071,G__23072,seq23070__$2);
});
...
var file = cljs.core.get.call(null,map__23077__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__23077__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__23077__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__23077,map__23077__$1,file,line,column){
return (function (p1__23076_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__23076_SHARP_));
});})(map__23077,map__23077__$1,file,line,column))
...
var temp__4657__auto___23079 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___23079)){
var message_23080 = temp__4657__auto___23079;
cljs.core.println.call(null,message_23080);
} else {
}
...
var temp__4657__auto___23081 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___23081)){
var message_23082 = temp__4657__auto___23081;
cljs.core.println.call(null,message_23082);
} else {
}
...
var output_dir__$1 = (function (){var G__23083 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23083),"/"].join('');
} else {
return G__23083;
}
})();
...
var G__23085 = exception.stack;
var G__23085__$1 = (((G__23085 == null))?null:clojure.string.split_lines.call(null,G__23085));
var G__23085__$2 = (((G__23085__$1 == null))?null:cljs.core.get.call(null,G__23085__$1,depth));
if((G__23085__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23085__$2);
}
} else {
...
var vec__23086 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__23086,(0),null);
var column = cljs.core.nth.call(null,vec__23086,(1),null);
var vec__23089 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__23089,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__23089,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__23089,(2),null);
...
var m__$1 = (function (){var G__23092 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__23096 = (function (){var G__23095 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__23095);
} else {
return G__23095;
}
})();
...
return cljs.core.vary_meta.call(null,G__23097,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__23101 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__23101,(0),null);
var types = vec__23101;
...
return cljs.core.map.call(null,(function (p__23104){
var vec__23105 = p__23104;
var ns = cljs.core.nth.call(null,vec__23105,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__23105,(1),null);
return ((function (vec__23105,ns,vars__$1){
return (function (){
...
var G__23108 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1){
return (function (){
var seq__23109 = cljs.core.seq.call(null,vars__$1);
var chunk__23110 = null;
var count__23111 = (0);
var i__23112 = (0);
while(true){
if((i__23112 < count__23111)){
var v = cljs.core._nth.call(null,chunk__23110,i__23112);
var temp__4657__auto___23114 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___23114)){
var t_23115 = temp__4657__auto___23114;
each_fixture_fn.call(null,((function (seq__23109,chunk__23110,count__23111,i__23112,t_23115,temp__4657__auto___23114,v,each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23115)));
});})(seq__23109,chunk__23110,count__23111,i__23112,t_23115,temp__4657__auto___23114,v,each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1))
);
} else {
}


var G__23116 = seq__23109;
var G__23117 = chunk__23110;
var G__23118 = count__23111;
var G__23119 = (i__23112 + (1));
seq__23109 = G__23116;
chunk__23110 = G__23117;
count__23111 = G__23118;
i__23112 = G__23119;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__23109);
if(temp__4657__auto__){
var seq__23109__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__23109__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__23109__$1);
var G__23120 = cljs.core.chunk_rest.call(null,seq__23109__$1);
var G__23121 = c__4319__auto__;
var G__23122 = cljs.core.count.call(null,c__4319__auto__);
var G__23123 = (0);
seq__23109 = G__23120;
chunk__23110 = G__23121;
count__23111 = G__23122;
i__23112 = G__23123;
continue;
} else {
var v = cljs.core.first.call(null,seq__23109__$1);
var temp__4657__auto___23124__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___23124__$1)){
var t_23125 = temp__4657__auto___23124__$1;
each_fixture_fn.call(null,((function (seq__23109,chunk__23110,count__23111,i__23112,t_23125,temp__4657__auto___23124__$1,v,seq__23109__$1,temp__4657__auto__,each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_23125)));
});})(seq__23109,chunk__23110,count__23111,i__23112,t_23125,temp__4657__auto___23124__$1,v,seq__23109__$1,temp__4657__auto__,each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1))
);
} else {
}


var G__23126 = cljs.core.next.call(null,seq__23109__$1);
var G__23127 = null;
var G__23128 = (0);
var G__23129 = (0);
seq__23109 = G__23126;
chunk__23110 = G__23127;
count__23111 = G__23128;
i__23112 = G__23129;
continue;
}
} else {
...
});})(each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1))
);
});})(each_fixture_fn,G__23108,G__23108__$1,env,once_fixtures,each_fixtures,vec__23105,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1532367309927
