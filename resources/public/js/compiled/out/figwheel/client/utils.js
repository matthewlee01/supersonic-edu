...
return (new CustomEvent(event_name,(function (){var obj29801 = {"detail":data};
return obj29801;
})()));
} else {
...
var f = (function (){var pred__29808 = cljs.core._EQ_;
var expr__29809 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29808.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29809))){
return ((function (pred__29808,expr__29809){
return (function (p1__29802_SHARP_){
return console.warn(p1__29802_SHARP_);
});
;})(pred__29808,expr__29809))
} else {
if(cljs.core.truth_(pred__29808.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29809))){
return ((function (pred__29808,expr__29809){
return (function (p1__29803_SHARP_){
return console.debug(p1__29803_SHARP_);
});
;})(pred__29808,expr__29809))
} else {
if(cljs.core.truth_(pred__29808.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29809))){
return ((function (pred__29808,expr__29809){
return (function (p1__29804_SHARP_){
return console.error(p1__29804_SHARP_);
});
;})(pred__29808,expr__29809))
} else {
return ((function (pred__29808,expr__29809){
return (function (p1__29805_SHARP_){
return console.log(p1__29805_SHARP_);
});
;})(pred__29808,expr__29809))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29812){
...
var opts = map__29813__$1;
var eval_fn = cljs.core.get.call(null,map__29813__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29815_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29817,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1532367480016
