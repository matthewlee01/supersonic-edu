...
return (new CustomEvent(event_name,(function (){var obj25147 = {"detail":data};
return obj25147;
})()));
} else {
...
var f = (function (){var pred__25154 = cljs.core._EQ_;
var expr__25155 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25154.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25155))){
return ((function (pred__25154,expr__25155){
return (function (p1__25148_SHARP_){
return console.warn(p1__25148_SHARP_);
});
;})(pred__25154,expr__25155))
} else {
if(cljs.core.truth_(pred__25154.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25155))){
return ((function (pred__25154,expr__25155){
return (function (p1__25149_SHARP_){
return console.debug(p1__25149_SHARP_);
});
;})(pred__25154,expr__25155))
} else {
if(cljs.core.truth_(pred__25154.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25155))){
return ((function (pred__25154,expr__25155){
return (function (p1__25150_SHARP_){
return console.error(p1__25150_SHARP_);
});
;})(pred__25154,expr__25155))
} else {
return ((function (pred__25154,expr__25155){
return (function (p1__25151_SHARP_){
return console.log(p1__25151_SHARP_);
});
;})(pred__25154,expr__25155))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25158){
...
var opts = map__25159__$1;
var eval_fn = cljs.core.get.call(null,map__25159__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25161_SHARP_);
});})(new_def))
);
...
return (function (p__25162){
var vec__25163 = p__25162;
var ky = cljs.core.nth.call(null,vec__25163,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1532452670560
