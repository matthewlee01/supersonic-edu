...
return (new CustomEvent(event_name,(function (){var obj44428 = {"detail":data};
return obj44428;
})()));
} else {
...
var f = (function (){var pred__44435 = cljs.core._EQ_;
var expr__44436 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__44435.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__44436))){
return ((function (pred__44435,expr__44436){
return (function (p1__44429_SHARP_){
return console.warn(p1__44429_SHARP_);
});
;})(pred__44435,expr__44436))
} else {
if(cljs.core.truth_(pred__44435.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__44436))){
return ((function (pred__44435,expr__44436){
return (function (p1__44430_SHARP_){
return console.debug(p1__44430_SHARP_);
});
;})(pred__44435,expr__44436))
} else {
if(cljs.core.truth_(pred__44435.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__44436))){
return ((function (pred__44435,expr__44436){
return (function (p1__44431_SHARP_){
return console.error(p1__44431_SHARP_);
});
;})(pred__44435,expr__44436))
} else {
return ((function (pred__44435,expr__44436){
return (function (p1__44432_SHARP_){
return console.log(p1__44432_SHARP_);
});
;})(pred__44435,expr__44436))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__44439){
var map__44440 = p__44439;
var map__44440__$1 = ((((!((map__44440 == null)))?(((((map__44440.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44440.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__44440):map__44440);
var opts = map__44440__$1;
var eval_fn = cljs.core.get.call(null,map__44440__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__44442_SHARP_);
});})(new_def))
);
...
return (function (p__44443){
var vec__44444 = p__44443;
var ky = cljs.core.nth.call(null,vec__44444,(0),null);
var v = cljs.core.nth.call(null,vec__44444,(1),null);
...
}catch (e44449){if((e44449 instanceof Error)){
var e = e44449;
return not_found;
} else {
throw e44449;
...
//# sourceMappingURL=utils.js.map?rel=1532451320005
